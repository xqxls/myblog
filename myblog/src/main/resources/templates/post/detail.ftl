                ...
                <div class="fly-detail-info">
                    ...
                    <div class="fly-admin-box" data-id= ${post.id}>
                        ...
                        <@shiro.hasRole name="admin">
                            ...
                            <#if post.level == 0><span class="layui-btn layui-btn-xs jie-admin" type="set" field="stick"
                                                       rank="1">置顶</span></#if>
                            <#if post.level gt 0><span class="layui-btn layui-btn-xs jie-admin" type="set" field="stick"
                                                       rank="0" style="background-color:#ccc;">取消置顶</span></#if>

                            <#if !post.recommend><span class="layui-btn layui-btn-xs jie-admin" type="set"
                                                       field="status" rank="1">加精</span></#if>
                            <#if post.recommend><span class="layui-btn layui-btn-xs jie-admin" type="set" field="status"
                                                      rank="0" style="background-color:#ccc;">取消加精</span></#if>
                        </@shiro.hasRole>
            ...
            <div class="fly-panel detail-box" id="flyReply">
                ...
                <ul class="jieda" id="jieda">
                    ...
                    <a href="/user/${comment.authorId}" class="fly-link">
                        ...
                        <#if comment.authorId == post.authorId><span>(楼主)</span></#if>
